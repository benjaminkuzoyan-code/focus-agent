...
}
{
  ...
  var validateFileURL = function (file) {
    ...
    try {
      ...
      // Focus Agent: this viewer runs as an extension page and opens PDFs
      // from any origin the student granted (optional_host_permissions).
      // The generic build's same-origin check is disabled on purpose.
