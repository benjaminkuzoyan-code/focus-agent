 ...
 *   settings         {dataSource: "mock"|"auto", sessionMin, checkinMin, mode: "tutor"|"answer"}
 */
(() => {
  const FA = (globalThis.FA = globalThis.FA || {});

  const DEFAULT_SETTINGS = { dataSource: "mock", sessionMin: 25, checkinMin: 10, mode: "tutor", devMode: false };
  ...
  FA.store = {
    ...
    async startSession(assignment, plannedMin) {
      const session = {
